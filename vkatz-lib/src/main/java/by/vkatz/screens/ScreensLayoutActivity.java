...
public abstract class ScreensLayoutActivity extends Activity {
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        return keyCode == KeyEvent.KEYCODE_MENU && screensLayout.onMenuPressed() || super.onKeyUp(keyCode, event);
    }
